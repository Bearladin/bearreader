...
class StaticFilesGuard:
    ...
    async def __call__(self, scope, receive, send):
        ...
        try:
            ...
            # invalid/expired token: return 401/403 instead of an unhandled
            # 500 — this middleware sits outside FastAPI's exception handlers
            await err.to_response()(scope, receive, send)
            return
